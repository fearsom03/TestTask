...
public class ObjectsAdapter extends RecyclerView.Adapter<ObjectsAdapter.ViewHolder> {
    ...
    public ObjectsAdapter(int countObjects, JSONArray Data) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.objects_adapter,viewGroup,false);
            ...
            //implements View.OnClickListener
    {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.Data_object);
            descripting = itemView.findViewById(R.id.subData_object);
            image = itemView.findViewById(R.id.ImageView_row_object);
        }
//        @Override
